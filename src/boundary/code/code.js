...
//       a.download = `${UniqueName}.js`;
//       a.href = window.URL.createObjectURL(
//         new Blob(['const data = ' + JSON.stringify(parseResult)], { type: "text/plain" })
//       );
//       a.click();
//     })
...
// };
  ...
  // useEffect(() => {
  //   for (let i = 20; i < 30 && dataObj.data.length > i; i++) {
  //     const distric = dataObj.data[i];
